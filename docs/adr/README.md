...
Este diretório registra as decisões arquiteturais relevantes do sistema de super-resolution batch. As ADRs foram derivadas dos documentos do projeto e servem para congelar decisões que não devem ser rediscutidas a cada implementação.

## Índice

- [0001-arquitetura-cli-local-monolitica.md](/home/edgar/dev/upscale_image/docs/adr/0001-arquitetura-cli-local-monolitica.md)
...
- [0004-contrato-de-modelo-e-registry.md](/home/edgar/dev/upscale_image/docs/adr/0004-contrato-de-modelo-e-registry.md)
